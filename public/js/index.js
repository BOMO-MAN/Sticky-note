...
/* WEBPACK VAR INJECTION */(function($) {// var Toast = require('./toast.js').Toast;
...
/* WEBPACK VAR INJECTION */(function($) {// require('less/note.less');
...
// 		this.opts = $.extent({},this.defaultOpts,opts||{});
// 		if(this.opts.id){
